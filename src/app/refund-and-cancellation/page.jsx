    ...
    return (
        <div className="flex w-full h-auto md:items-center md:justify-center ">
            <div className="flex flex-col w-full max-w-7xl mx-auto px-4 gap-6 md:gap-8 lg:gap-12 xl:gap-16 py-8 md:py-12 lg:py-16">
                ...
                <div className="prose prose-ul:text-sm md:prose-ul:text-base lg:prose-ul:text-lg lg:prose-xl space-y-4 md:space-y-6 prose-p:text-sm md:prose-p:text-base max-w-5xl mx-auto lg:prose-p:text-lg prose-strong:mx-2 prose-h2:text-xl md:prose-h2:text-2xl lg:prose-h2:text-3xl">
                    <p>
