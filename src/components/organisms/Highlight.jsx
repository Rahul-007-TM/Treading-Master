        ...
        <div className="flex w-full h-auto md:items-center md:justify-center ">
            <div className="flex flex-col w-full max-w-7xl mx-auto px-4 gap-6 md:gap-8 lg:gap-12 xl:gap-16 py-8 md:py-12 lg:py-16">
                <div className="flex w-full">
                    <h2 className="flex text-2xl md:text-3xl lg:text-4xl items-center justify-center font-bold w-full text-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full">
                    {
                        Highlights.map((highlight, i) =>
                            <Card key={i}>
                                ...
                                <CardHeader>
                                    <CardTitle className="text-base text-center">{highlight.label}</CardTitle>
                                </CardHeader>
                            </Card>
                        )
                    }
